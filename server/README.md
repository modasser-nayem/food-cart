...
```
git clone https://github.com/modasser-nayem/food-cart.git
...
Ali Modasser Nayem - [Linkedin](https://www.linkedin.com/in/alimodassernayem/) - modassernayem@gimail.com
